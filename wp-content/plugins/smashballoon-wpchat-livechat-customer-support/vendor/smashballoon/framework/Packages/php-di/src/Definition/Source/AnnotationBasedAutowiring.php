...
use SmashBalloon\WPChat\Vendor\DI\Annotation\Inject;
use SmashBalloon\WPChat\Vendor\DI\Annotation\Injectable;
use SmashBalloon\WPChat\Vendor\DI\Definition\Exception\InvalidAnnotation;
use SmashBalloon\WPChat\Vendor\DI\Definition\ObjectDefinition;
use SmashBalloon\WPChat\Vendor\DI\Definition\ObjectDefinition\MethodInjection;
use SmashBalloon\WPChat\Vendor\DI\Definition\ObjectDefinition\PropertyInjection;
use SmashBalloon\WPChat\Vendor\DI\Definition\Reference;
use SmashBalloon\WPChat\Vendor\Doctrine\Common\Annotations\AnnotationRegistry;
use SmashBalloon\WPChat\Vendor\Doctrine\Common\Annotations\Reader;
use SmashBalloon\WPChat\Vendor\Doctrine\Common\Annotations\SimpleAnnotationReader;
use InvalidArgumentException;
use SmashBalloon\WPChat\Vendor\PhpDocReader\PhpDocReader;
use ReflectionClass;
...
class AnnotationBasedAutowiring implements DefinitionSource, Autowiring
{
    ...
    private function readProperty(ReflectionProperty $property, ObjectDefinition $definition, $classname = null)
    {
        ...
        $annotation = $this->getAnnotationReader()->getPropertyAnnotation($property, 'SmashBalloon\WPChat\Vendor\DI\Annotation\Inject');
    ...
    private function getMethodInjection(ReflectionMethod $method)
    {
        // Look for @Inject annotation
        try {
            $annotation = $this->getAnnotationReader()->getMethodAnnotation($method, 'SmashBalloon\WPChat\Vendor\DI\Annotation\Inject');
    ...
    public function getAnnotationReader()
    {
        if ($this->annotationReader === null) {
            ...
            $this->annotationReader->addNamespace('SmashBalloon\WPChat\Vendor\DI\Annotation');
        }
    ...
    private function readInjectableAnnotation(ReflectionClass $class, ObjectDefinition $definition)
    {
        try {
            ...
            $annotation = $this->getAnnotationReader()->getClassAnnotation($class, 'SmashBalloon\WPChat\Vendor\DI\Annotation\Injectable');
