 ...
 * @package Notices
 */
namespace SmashBalloon\WPChat\Vendor\Smashballoon\Framework\Packages\Notification\Notices;

use SmashBalloon\WPChat\Vendor\Smashballoon\Framework\Packages\Notification\Notices\AdminNotice;
use function SmashBalloon\WPChat\Vendor\Smashballoon\Framework\sb_map_notice_hooks;
use function SmashBalloon\WPChat\Vendor\Smashballoon\Framework\sb_get_plugin_type;
if (!defined('ABSPATH')) {
    exit;
}
/**
