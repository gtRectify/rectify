<div v-if="selected === 'app-1'">
	...
	<div class="sb-tab-box sb-license-box clearfix">
		...
		<div class="sbi-tab-form-field d-flex">
			<div v-if="licenseType === 'free'" class="sbi-tab-field-inner-wrap sbi-license"
				...
				<div class="field-left-content">
					<div class="sb-form-field">
						<input type="password" name="license-key" id="license-key" class="sbi-form-field"
							   :placeholder="generalTab.licenseBox.inactiveFieldPlaceholder">
					</div>
			...
			<div v-if="licenseType === 'pro' && (
				...
				<div class="d-flex">
						...
						<div class="form-info d-flex justify-between">
							...
							<span>
								...
								<span v-html="testConnectionIcon()" class="test-connection"
									  :class="testConnectionStatus" v-if="testConnectionStatus !== null"></span>
								<span class="recheck-license-status" @click="recheckLicense('sbi')"
									  v-html="recheckBtnText('sbi')" :class="recheckLicenseStatus"></span>
					...
					<div class="field-right-content">
						<button type="button" class="sbi-btn" v-on:click="deactivateLicense"
					...
					<div class="field-left-content">
						...
						<div class="form-info d-flex justify-between">
							...
							<span>
								...
								<span v-html="testConnectionIcon()" class="test-connection"
									  :class="testConnectionStatus" v-if="testConnectionStatus !== null"></span>
								<span class="recheck-license-status"
									  @click="recheckLicense(licenseKey, pluginItemName, 'sbi')"
									  v-html="recheckBtnText('sbi')" :class="recheckLicenseStatus"></span>
		...
		<div class="sb-protopro-upgrade-ctn">
			<div class="sb-protopro-upgrade-text">
				<strong>
					...
					<span class="sb-protopro-upgrade-type" v-if="licenseUpgradedInfoTierName !== null"
						  v-html="licenseUpgradedInfoTierName"></span>
				</strong>
				...
				<div class="sb-sources-list">
					...
					<div class="sb-srcs-item" v-for="(source, sourceIndex) in sourcesList"
						...
						<div class="sbi-fb-srcs-item-ins">
							...
							<div
								:class="{'sb-srcs-item-inf-err-action-wrap' : source.error !== '', 'sb-srcs-item-inf-action-wrap' : source.error == ''}">
								...
								<div class="sb-srcs-item-errors">
									<div v-if="source.error !== '' || source.error_encryption"
										...
										<svg width="13" height="13" viewBox="0 0 13 13" fill="none"
											 xmlns="http://www.w3.org/2000/svg">
											<path
												d="M6.50008 0.666664C3.28008 0.666664 0.666748 3.28 0.666748 6.5C0.666748 9.72 3.28008 12.3333 6.50008 12.3333C9.72008 12.3333 12.3334 9.72 12.3334 6.5C12.3334 3.28 9.72008 0.666664 6.50008 0.666664ZM7.08342 9.41667H5.91675V8.25H7.08342V9.41667ZM7.08342 7.08333H5.91675V3.58333H7.08342V7.08333Z"
												fill="#D72C2C"/>
										</svg>

										<span
											v-html="source.error !== '' ? genericText.errorSource : genericText.errorEncryption"></span><a
											href="#"
											@click.prevent.default="activateView('sourcePopup', 'creationRedirect')"
						...
						<div class="sbi-fb-srcs-personal-btn"
							...
							<span
								v-html="source?.header_data?.biography || source?.local_avatar_url ? genericText.updateAccountInfo : genericText.addAccountInfo"></span>
						</div>
					</div>
...
<div class="sb-fs-boss sb-pro-newversion-popup-ctn" v-if="upgradeNewVersion === true && upgradeNewVersionUrl !== false">
	<div class="sb-pro-newversion-popup">
		<div class="sb-pro-newversion-popup-txt">
			<strong><?php esc_html_e('The plugin will be updated to a newer version', 'instagram-feed'); ?> <span
					style="color:blue">{{upgradeRemoteVersion}}</span></strong>
		...
		<div class="sb-pro-newversion-popup-btns">
			...
			<button type="button" class="sbi-btn sb-btn-blue"
					@click.prevent.default="window.location.href = upgradeNewVersionUrl">
