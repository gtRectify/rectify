...
class SBI_oEmbeds
{
	 ...
	 * @var string
	 */
	protected const SLUG = 'sbi-oembeds-manager';
	...
	public function statuses_and_info()
	{
		...
		$return = array(
			...
			'genericText' => array(
				...
				'whenYouPaste' => __('When you paste a link to an Instagram or Facebook post in WordPress, it automatically displays the post instead of the URL. That is called an oEmbed.', 'instagram-feed'),
	 ...
	 *
	 * @param string $saved_access_token_data The saved access token data.
	 *
	 * @return array|bool
	 *
	 * @since 6.0
