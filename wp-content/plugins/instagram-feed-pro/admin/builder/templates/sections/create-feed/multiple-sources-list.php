	...
	<div class="sbi-feedtype-sec-heading sbi-fb-fs">
		...
		<div class="sbi-feedtype-sec-wrap">
			<div class="sbi-feedtype-sec-icon-heading sbi-fb-fs">
				...
				<a href="https://smashballoon.com/doc/instagram-business-profiles/?utm_campaign=instagram-pro&utm_source=customizer&utm_medium=docs" target="_blank"
				   v-if="feedType.businessRequired != undefined && feedType.businessRequired">
					<span v-html="genericText.businessRequired"></span>
					<div class="sb-control-elem-tltp" v-if="feedType.tooltip != undefined"
						 @mouseover.prevent.default="toggleElementTooltip(feedType.tooltip, 'show', feedType.tooltipAlign ? feedType.tooltipAlign : 'center' )"
			...
			<div class="sbi-feedtype-sec-desc sbi-fb-fs sb-caption sb-lighter" v-if="feedType.description != undefined"
				 v-html="feedType.description"></div>
