<div class="sbi-license-learn-more sbc-popup-blur-background sb-fs-boss sbi-fb-center-boss"
	 v-if="viewsActive.licenseLearnMore != null && viewsActive.licenseLearnMore != false">
	<div class="sbc-extensions-popup sbi-fb-popup-inside"
		 v-if="viewsActive.licenseLearnMore != null && viewsActive.licenseLearnMore != false">
		<div class="sbi-fb-popup-cls" @click.prevent.default="activateView('licenseLearnMore')">
			...
			<div class="sb-llm-license-key-block">
				<div class="sb-license-checker-form">
					...
					<div class="sb-right">
						<div class="sb-modal-license-key-form">
							<input type="password" placeholder="Paste license key here" class="sb-input"
								   v-model="licenseKey">
							<button @click="activateLicense()"
									class="sb-btn-default sb-btn-blue sb-btn-license-activate">
				...
				<div class="sb-llm-lk-footer">
					<p>
						...
						<a href="<?php echo "https://smashballoon.com/pricing/instagram-feed/?utm_campaign=instagram-pro&utm_source=customizer&utm_medium=marketing"; ?>" target="_blank">
							Buy a License
							<svg width="7" height="10" viewBox="0 0 7 10" fill="none"
								 xmlns="http://www.w3.org/2000/svg">
								<path d="M1.8332 0L0.658203 1.175L4.47487 5L0.658203 8.825L1.8332 10L6.8332 5L1.8332 0Z"
									  fill="#0068A0"/>
							</svg>
						</a>
					</p>
