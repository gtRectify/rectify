...
class SBI_Support
{
	 ...
	 * @var string
	 */
	protected const SLUG = 'sbi-support';
	...
	public function page_data()
	{
		...
		return array(
			...
			'siteSearchUrl' => 'https://smashballoon.com/search/?utm_campaign=instagram-pro&utm_source=support&utm_medium=support',
	...
	public static function get_global_settings_info()
	{
		...
		$output .= 'License key: ';
		$output .= $sbi_license_key ? esc_html($sbi_license_key) : ' Not added';
		$output .= '</br>';
		$output .= 'License status: ';
		$output .= $sbi_license_status ?: ' Inactive';
		$output .= '</br>';
		...
		$output .= '</br>';
		$output .= 'GDPR: ';
		$output .= $sbi_settings['gdpr'] ?? ' Not setup';
		$output .= '</br>';
		$output .= 'Custom CSS: ';
		$output .= !empty($sbi_settings['sb_instagram_custom_css']) ? wp_strip_all_tags($sbi_settings['sb_instagram_custom_css']) : 'Empty';
		$output .= '</br>';
		$output .= 'Custom JS: ';
		$output .= !empty($sbi_settings['sb_instagram_custom_js']) ? $sbi_settings['sb_instagram_custom_js'] : 'Empty';
		$output .= '</br>';
		...
		$output .= isset($sbi_settings['email_notification']) ? ucfirst($sbi_settings['email_notification']) : 'Off';
		$output .= '</br>';
		$output .= 'Email notification addresses: ';
		$output .= !empty($sbi_settings['email_notification_addresses']) ? sanitize_email($sbi_settings['email_notification_addresses']) : 'Not available';
		$output .= '</br>';
		$output .= '</br>';
		return $output;
	}
	...
	public static function get_sources_info()
	{
		...
		foreach ($source_list as $source) {
			$account_type = $source['header_data']['account_type'] ?? 'Business Advanced';
	...
	{
		$url = 'https://smashballoon.com/instagram-feed/support/?utm_campaign=instagram-pro&utm_source=support&utm_medium=support';
