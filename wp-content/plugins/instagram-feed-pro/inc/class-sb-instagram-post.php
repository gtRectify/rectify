...
class SB_Instagram_Post
{
	...
	/**
	 * The data from the Instagram API.
	 *
	 * @var array
	 */
	...
	/**
	 * The ID of the post in the custom table.
	 *
	 * @var string
	 */
	private $db_id;
	...
	/**
	 * The media ID of the post in the custom table.
	 *
	 * @var string
	 */
	private $media_id;
	...
	/**
	 * The top time stamp of the post in the custom table.
	 *
	 * @var string
	 */
	...
	/**
	 * Whether or not the images have been resized.
	 *
	 * @var bool|int
	 */
	private $images_done;
	...
	/**
	 * Used to set the Instagram API data for the post.
	 *
	 * @param array $instagram_api_data Array of data from the Instagram API.
	 *
	 * @since 2.0/4.0
	 */
	 ...
	 *
	 * @param mixed|string|bool $transient_name (optional) The feed ID.
	 * @param null              $timestamp_override (optional) The timestamp to use for the post.
	 *
	 * @return bool
	 * @since 2.0/4.0
	 */
	 ...
	 *
	 * @param bool $all (optional) Whether or not to get all the data.
	 *
	 * @return array
	 * @since 2.0/4.0
	 */
	 ...
	 *
	 * @param string $transient_name The feed ID.
	 *
	 * @return int
	 * @since 2.0/4.0
	 */
	...
	/**
	 * Update the post_json in the database
	 */
	public function update_post_json_db()
	{
	 ...
	 *
	 * @param bool   $update_last_requested (optional) Whether or not to update the last requested column.
	 * @param bool   $transient_name (optional) The feed ID.
	 * @param array  $image_sizes (optional) The image sizes to create.
	 * @param string $upload_dir (optional) The upload directory.
	 * @param string $upload_url (optional) The upload URL.
	 * @param bool   $timestamp_for_update (optional) The timestamp to use for the post.
	 *
	 * @return bool
	 *
	 * @since 2.0/4.0
	 ...
	 * @param string $val The value for the image.
	 *
	 * @since 2.0/4.0
	 */
