...
class SB_Instagram_API_Connect
{
	 ...
	 * @param string $endpoint (optional) This is optional only if the complete URL is provided,
	 *  otherwise it is the key for the endpoint needed for the request (e.g., "header").
	 ...
	 *
	 * @param string $url The url to be used for the API request.
	 */
	 ...
	 *
	 * @param array|bool $response (optional) If not provided, uses the response from the API request.
	 * @return bool
	 *
	 * @since 2.0/5.0
	 */
	...
	/** Update the access token for the connected account.
	 *
	 * @since 6.1
	 */
	 ...
	 *
	 * @param bool $bypass_connect_response (optional) If true, does not fire the action.
	 * @since 2.0/5.0
	 */
