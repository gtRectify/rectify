...
class SBI_Notifications
{
	 ...
	 * @var string
	 */
	public const SOURCE_URL = 'https://plugin.smashballoon.com/notifications.json';
	 ...
	 * @var string
	 */
	public const OPTION_NAME = 'sbi_notifications';
	...
	/**
	 * Checks if the plugin is recently installed.
	 *
	 * @return bool
	 *
	 * @since 1.4.5/1.4.2
	...
	public function output()
	{
		...
		foreach ($notifications as $notification) {
			...
			} elseif ($notification['image'] === 'balloon') {
				$image = array(
			...
			switch ($type) {
				case 'review':
					$sbi_open_feedback_url = 'https://smashballoon.com/feedback/?plugin=instagram-lite&utm_campaign=instagram-pro&utm_source=notifications&utm_medium=feedback';
	...
	/**
	 * Replaces merge fields in the given content with values from the notification.
	 *
	 * @param string $content The content containing merge fields to be replaced.
	 * @param array  $notification The notification data containing values for merge fields.
	 * @return string The content with merge fields replaced by actual values.
	 */
