...
class SBI_Modern_Feed_Block extends SB_Feed_Block
{
	...
	{
		return $this->get_plugin_dir()
			. 'vendor/smashballoon/framework/Packages/Blocks/dist/feed-blocks/instagram';
	}

	/**
	 * Get the editor localize data for the Instagram feed block.
	 *
	 * @return array
	 */
	...
	/**
	 * Register hooks for the modern feed block.
	 *
	 * @return void
	 */
