...
class SBI_Feed_Builder
{
	...
	/**
	 * Get the singleton instance of the SBI_Feed_Builder class.
	 *
	 * @return SBI_Feed_Builder The singleton instance of the SBI_Feed_Builder class.
	 */
	 ...
	 *
	 * @param bool   $check_nonce Whether or not to check nonce.
	 * @param string $action Action to verify the nonce.
	 *
	 * @since 6.0
	 */
	...
	/**
	 * Displays a modal for other plugins.
	 *
	 * @return void
	 */
	...
	/**
	 * Generates SVG icons for the feed builder.
	 *
	 * This function returns the SVG markup for various icons used in the feed builder.
	 *
	 * @param string|null $icon The name of the icon to generate. If null, returns a default icon.
	 * @return string The SVG markup for the requested icon.
	 */
	 ...
	 *
	 * @param int $page The number of pages.
	 *
	 * @return array
	 * @since 6.0
	 */
	...
	/**
	 * Checks if there is an encryption error with the given source and encryption.
	 *
	 * @param mixed $source The source to check for encryption errors.
	 * @param mixed $encryption The encryption method or data to check against.
	 * @return bool True if there is an encryption error, false otherwise.
	 */
	...
	/**
	 * Checks if there is an account type update notice for the given source.
	 *
	 * @param mixed $source The source to check for an account type update notice.
	 * @return bool True if there is an account type update notice, false otherwise.
	 */
	private static function has_account_type_update_notice($source)
	{
		if (isset($source['account_type']) && isset($source['header_data']['account_type'])) {
			...
			$hasProfilePicture = !empty($source['header_data']['profile_picture_url']);
	...
	/**
	 * Updates the onboarding meta information.
	 *
	 * @param mixed  $value The value to be set for the onboarding meta.
	 * @param string $type The type of onboarding meta to update. Default is 'newuser'.
	 *
	 * @return void
	 */
	...
	public static function get_smashballoon_plugins_info()
	{
		...
		return [
			'facebook' => [
				...
				'link' => 'https://smashballoon.com/custom-facebook-feed/?utm_campaign=instagram-pro&utm_source=about-us&utm_medium=marketing',
			...
			'instagram' => [
				...
				'link' => 'https://smashballoon.com/instagram-feed/?utm_campaign=instagram-pro&utm_source=about-us&utm_medium=marketing',
			...
			'twitter' => [
				...
				'link' => 'https://smashballoon.com/custom-twitter-feeds/?utm_campaign=instagram-pro&utm_source=about-us&utm_medium=marketing',
			...
			'youtube' => [
				...
				'link' => 'https://smashballoon.com/youtube-feed/?utm_campaign=instagram-pro&utm_source=about-us&utm_medium=marketing',
		...
		if (get_current_screen()) :
			...
			if (strpos($screen->id, 'sbi-feed-builder') !== false) :
				...
				$sbi_builder = array(
					...
					'sbiLicenseNoticeActive' => empty(sbi_builder_pro()->license_service->get_license_key) || sbi_builder_pro()->license_service->expiredLicenseWithGracePeriodEnded,
	...
	public static function get_generic_text()
	{
		return array(
			...
			'errorDirections' => '<a href="https://smashballoon.com/instagram-feed/docs/errors/?utm_campaign=instagram-pro&utm_source=customizer&utm_medium=docs" target="_blank" rel="noopener">' . __('Directions on How to Resolve This Issue', 'instagram-feed') . '</a>',
	...
	/**
	 * Retrieves the social wall links.
	 *
	 * @return array An array of social wall links.
	 */
	 ...
	 *
	 * @param string $type The onboarding status type.
	...
	public function getFooterUpsellContent()
	{
		$footers = [
			'social_wall' => [
				...
				/* translators: %1$s and %2$s are HTML span tags, %3$s and %4$s are HTML strong tags */
	...
	public static function get_links_with_utm()
	{
		...
		$all_access_bundle = sprintf('https://smashballoon.com/all-access/?license_key=%s&upgrade=true&utm_campaign=instagram-pro&utm_source=all-feeds&utm_medium=footer-banner&utm_content=learn-more', sanitize_key($license_key));
		$all_access_bundle_popup = sprintf('https://smashballoon.com/all-access/?license_key=%s&upgrade=true&utm_campaign=instagram-pro&utm_source=balloon&utm_medium=all-access', sanitize_key($license_key));
		$sourceCombineCTA = sprintf('https://smashballoon.com/social-wall/?license_key=%s&upgrade=true&utm_campaign=instagram-pro&utm_source=customizer&utm_medium=sources&utm_content=social-wall', sanitize_key($license_key));
		...
		return array(
			...
			'modal' => array(
				...
				'addAppSteps' => array(
					...
					/* translators: %1$s is the opening anchor tag for the tooltip, %2$s is the image tag for the screenshot */
	...
	public static function get_smashballoon_info()
	{
		return array(
			...
			'upgrade' => array(
				...
				'icon' => 'instagram',
				'link' => 'https://smashballoon.com/instagram-feed/?utm_campaign=instagram-pro&utm_source=customizer&utm_medium=marketing',
			),
			'platforms' => array(
				array(
					'name' => __('Facebook Feed', 'instagram-feed'),
	...
	/**
	 * Retrieves a list of Instagram feeds based on the provided arguments.
	 *
	 * @param array $feeds_args Optional. An array of arguments to filter the feeds. Default is an empty array.
	 *
	 * @return array An array of Instagram feeds that match the provided arguments.
	 */
	...
	/**
	 * Get the legacy feed name based on the provided sources list and source ID.
	 *
	 * @param array      $sources_list List of sources.
	 * @param string|int $source_id The ID of the source.
	 * @return string The legacy feed name.
	 */
	 ...
	 *
	 * @param string $license_key License key to generate the buy url.
	 * @return array
	 * @since 6.2.0
	 */
	public function get_extensions_popup($license_key)
	{
		return [
			...
			'socialwall' => [
				...
				'buyUrl' => $this->get_extension_popup_dynamic_buy_url($license_key, 'https://smashballoon.com/social-wall/demo/?license_key=%s&upgrade=true&utm_campaign=instagram-free&utm_source=feed-type&utm_medium=social-wall&utm_content=Try Demo'),
				'bullets' => [
	...
	/**
	 * Generates the dynamic heading for the extension popup.
	 *
	 * @param string $extension_title The title of the extension.
	 * @param string $license_tier Optional. The license tier of the extension. Default is an empty string.
	 * @return string The dynamic heading for the extension popup.
	 */
	public function get_extension_popup_dynamic_heading($extension_title, $license_tier = '')
	{
		...
		} elseif (sbi_license_notices_active()) {
			/* translators: %s is the title of the extension */
			return sprintf(__('Renew license to get %s', 'instagram-feed'), $extension_title);
		} else {
			/* translators: 1: License tier, 2: Extension title */
			return sprintf(__('Upgrade to %1$s to get %2$s', 'instagram-feed'), $license_tier, $extension_title);
		}
	}

	/**
	 * Generates a dynamic URL for purchasing an extension based on the provided license key.
	 *
	 * @param string $license_key The license key for the current user.
	 * @param string $default_upgrade_url The default URL to upgrade or purchase the extension.
	 * @return string The dynamically generated URL for purchasing the extension.
	 */
	...
	/**
	 * Adds custom attributes to the customizer.
	 *
	 * @param array $atts An array of attributes to be customized.
	...
	/**
	 * Enqueues global resources and scripts for the Instagram Feed Pro plugin.
	 *
	 * @param bool $is_settings Optional. Whether the settings page is being loaded. Default false.
	 */
	...
	public function get_customize_screens_text()
	{
		$text = array(
			...
			'likeBoxScreen' => array(
				...
				'customCTADescription' => __('This toggles the custom CTA like "Shop now" and "Contact"', 'instagram-feed'),
			...
			'postsScreen' => array(
				...
				'individual' => array(
					...
					'custom' => __('Custom', 'instagram-feed'),
					'learnMoreFormats' => '<a href="https://smashballoon.com/doc/date-formatting-reference/?utm_campaign=instagram-pro&utm_source=customizer&utm_medium=docs" target="_blank" rel="noopener">' . __('Learn more about custom formats', 'instagram-feed') . '</a>',
				...
				'individualProperties' => __('Individual Properties', 'instagram-feed'),
				// Deprecated typo'd alias kept for backwards compatibility with downstream JS consumers; remove once consumers migrate to `individualProperties`.
			...
			'shoppableFeedScreen' => array(
				...
				'description1' => __('This feature links the post to the one specified in your caption.<br/><br/>Don’t want to add links to the caption? You can add links manually to each post.<br/><br/>Enable it to get started.', 'instagram-feed'),
	...
	/**
	 * Retrieves the onboarding text for the customizer.
	 *
	 * @return string The onboarding text for the customizer.
	 */
