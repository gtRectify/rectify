...
class SBI_Db
{
	 ...
	 *
	 * @param array $to_update Data to update.
	 * @param array $where_data Where data.
	 *
	 * @return false|int
	 *
	 * @since 6.0
	 ...
	 *
	 * @param array $args Feeds query args.
	 *
	 * @return array|bool
	 *
	 * @since 6.0
	...
	public static function feeds_query($args = array())
	{
		...
		if (isset($args['social_wall_summary'])) {
			$sql = "SELECT id, feed_name FROM $feeds_table_name;";
	 ...
	 *
	 * @param string $sourcename Source name to query.
	 *
	 * @return array|bool
	 *
	 * @since 6.0
	 ...
	 *
	 * @param array $feed_ids_array Feed ids to query.
	 *
	 * @since 6.0
	 */
	 ...
	 *
	 * @param array $source_id Source id to query.
	 *
	 * @since 6.0
	 */
	 ...
	 * Query to Remove Source from Database
	 *
	 * @param array $source_id Source id to delete.
	 *
	 * @since 6.0
	 */
	...
	public static function feed_caches_query($args)
	{
		...
		} elseif (!isset($args['additional_batch'])) {
			$sql = $wpdb->prepare(
				"SELECT * FROM $feed_cache_table_name
	 ...
	 * the 6.0 update.
	 *
	 * @param bool $include_charset_collate Whether or not to include the charset collate.
	 *
	...
	/**
	 * Clears the caches for the Instagram feed.
	 *
	 * @return void
	 */
	...
	/**
	 * Clears the Instagram feed sources from the database.
	 *
	 * @return void
	 */
	...
	/**
	 * Resets the database update status.
	 *
	 * @return void
	 */
	...
	/**
	 * Resets the legacy settings or data for the Instagram Feed Pro plugin.
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param string $source_id Source id to query.
	 *
	 * @since 6.1
	 */
