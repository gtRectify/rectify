...
class Util
{
	 ...
	 *
	 * Uses native PHP unserialize() with options (available since PHP 7.0).
	 * This prevents object injection vulnerabilities by disallowing class instantiation.
	 *
	 * @param mixed $data Data to unserialize.
	 * @return mixed Unserialized data or original data if not a string.
	 * @since 6.0.5
	 */
	public static function safe_unserialize($data)
	{
		...
		// Use native PHP 7.0+ unserialize with options
