...
class SB_Instagram_Data_Manager
{
	 ...
	 *
	 * @param array $statuses New statuses to update.
	 *
	 * @since 2.9.4/5.12.4
	 */
	 ...
	 * Delete feed caches
	 *
	 * @param bool $include_backup Include backup caches.
	 *
	 * @since 2.9.4/5.12.4
	 */
	 ...
	 *
	 * @param string $username Username of the account to delete data for.
	 *
	 * @since 2.9.4/5.12.4
	 */
	 ...
	 *
	 * @throws Exception If the encryption key or salt is not set.
	 *
	 * @since 2.9.4/5.12.4
	 */
	 ...
	 *
	 * @param string $encrypted_value Encrypted value to encrypt.
	 *
	 * @return bool|string
	 *
	 * @since 2.9.4/5.12.4
	...
	/**
	 * Decrypts an encrypted value using a remote key and salt.
	 *
	 * This method retrieves a key and salt from a remote server if they are not already set,
	 * and uses them to decrypt the provided encrypted value.
	 *
	 * @param string $encrypted_value The value to be decrypted.
	...
	/**
	 * Update the expired media URLs for the given Instagram feed.
	 *
	 * @param object $instagram_feed The Instagram feed object.
	 * @param string $transient_name The name of the transient.
	 * @param array  $connected_accounts The array of connected accounts.
	 *
	 * @return void
	 */
