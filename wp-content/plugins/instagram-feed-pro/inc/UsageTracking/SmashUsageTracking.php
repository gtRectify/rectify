...
use InstagramFeed\UsageTracking\Instagram\InstagramReporter;
...
class SmashUsageTracking {
	...
	public function __construct() {
		$this->reporter        = new InstagramReporter();
	...
	public function enqueue_session_script() {
		...
		$path        = defined( 'SBI_PLUGIN_DIR' ) ? SBI_PLUGIN_DIR . $script_path : '';
	...
	/**
	 * Build the usage report payload without sending (e.g. for preview or when API is unavailable).
	 * Uses a placeholder site_token so no register_site call is made.
	 *
