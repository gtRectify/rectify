...
use InstagramFeed\Vendor\DI\Definition\FactoryDefinition;
...
use InstagramFeed\Vendor\DI\Definition\Resolver\ResolverDispatcher;
use InstagramFeed\Vendor\DI\Definition\Source\DefinitionArray;
use InstagramFeed\Vendor\DI\Definition\Source\MutableDefinitionSource;
use InstagramFeed\Vendor\DI\Definition\Source\ReflectionBasedAutowiring;
use InstagramFeed\Vendor\DI\Definition\Source\SourceChain;
use InstagramFeed\Vendor\DI\Definition\ValueDefinition;
use InstagramFeed\Vendor\DI\Invoker\DefinitionParameterResolver;
use InstagramFeed\Vendor\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use InstagramFeed\Vendor\Invoker\Invoker;
use InstagramFeed\Vendor\Invoker\InvokerInterface;
use InstagramFeed\Vendor\Invoker\ParameterResolver\AssociativeArrayResolver;
use InstagramFeed\Vendor\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use InstagramFeed\Vendor\Invoker\ParameterResolver\DefaultValueResolver;
use InstagramFeed\Vendor\Invoker\ParameterResolver\NumericArrayResolver;
use InstagramFeed\Vendor\Invoker\ParameterResolver\ResolverChain;
