<?php
/**
 * Foundation Repair page content template.
 *
 * Figma node 748:13766 ("Foundation Repair") in "Rectify - New Home".
 * Styles exclusively from assets/css/residential-inner-pages.css via the
 * shared "cracked-style" block system (.rx-cracked-* markup).
 *
...
$foundation_images = array(
    'intro'      => rx_asset_url( 'images/foundation-repair/intro-technician-van.png' ),
    'why_matter' => rx_asset_url( 'images/foundation-repair/why-assessment-technician.png' ),
    'before'     => rx_asset_url( 'images/foundation-repair/before-after-1.jpg' ),
    'after'      => rx_asset_url( 'images/foundation-repair/before-after-2.jpg' ),
    'contours'   => rx_asset_url( 'images/home/Contour on Navy Blue.png' ),
);

$causes = array(
    array(
        'image' => 'images/foundation-repair/reactive-clay-soils.jpg',
        'title' => 'Reactive Clay Soils',
        'copy'  => array(
            'Reactive clay expands during wet conditions and contracts as the ground dries. These repeated moisture changes place continual stress on foundations and can lead to differential settlement.',
        ),
    ),
    array(
        'image' => 'images/foundation-repair/poor-soil-compaction.jpg',
        'title' => 'Poor Soil Compaction',
        'copy'  => array(
            'If the fill material beneath a home was not adequately compacted during construction, it may continue to compress over time, causing foundations to settle unevenly.',
        ),
    ),
    array(
        'image' => 'images/foundation-repair/water-leaks-beneath-foundations.jpg',
        'title' => 'Water Leaks Beneath Foundations',
        'copy'  => array(
            'Leaking water services, damaged stormwater pipes or poor drainage can soften supporting soils and reduce their ability to carry structural loads.',
        ),
    ),
    array(
        'image' => 'images/foundation-repair/erosion.png',
        'title' => 'Erosion',
        'copy'  => array(
            'Groundwater movement and poor drainage may gradually wash supporting soils away, leaving foundations without adequate support.',
        ),
    ),
    array(
        'image' => 'images/foundation-repair/tree-root-activity.jpg',
        'title' => 'Tree Root Activity',
        'copy'  => array(
            'Large trees remove moisture from surrounding soils, particularly reactive clays, causing shrinkage and uneven foundation movement.',
        ),
    ),
    array(
        'image' => 'images/foundation-repair/natural-foundation-settlement.jpg',
        'title' => 'Natural Foundation Settlement',
        'copy'  => array(
            'Older homes often experience gradual settlement as soil conditions change over many years. While some movement is expected, excessive settlement should be professionally assessed.',
        ),
    ),
);
...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'post rx-cracked-page' ); ?>>
    ...
    if ( function_exists( 'rectify_pb_render_page_sections' ) ) :
        rectify_pb_render_page_sections( get_the_ID(), array(
            array(
                'key'    => 'residential-foundation-hero',
                'render' => function () {
                    ?>
                    <section class="rx-cracked-hero">
                        <div class="rx-wrap">
                            <span class="rx-kicker"><?php esc_html_e( 'WHAT WE RECTIFY', 'rectify-custom' ); ?></span>
                            <h1><?php esc_html_e( 'Foundation Repair Melbourne & South Australia', 'rectify-custom' ); ?></h1>
                            <nav class="rx-cracked-breadcrumb" aria-label="<?php esc_attr_e( 'Breadcrumb', 'rectify-custom' ); ?>">
                                ...
                                <span aria-hidden="true">&#8250;</span>
                                <span><?php esc_html_e( 'Foundation Repair', 'rectify-custom' ); ?></span>
                            </nav>
                        </div>
                    </section>
                    <?php
            ...
            array(
                'key'    => 'residential-foundation-intro',
                    ...
                    <section class="rx-cracked-band">
                        <div class="rx-wrap rx-cracked-intro-grid">
                            <div class="rx-cracked-intro-copy">
                                <h2><?php esc_html_e( 'Engineered Foundation Repair Solutions for Long-Term Structural Stability', 'rectify-custom' ); ?></h2>
                                <p><?php esc_html_e( "Your home's foundation supports the entire structure. When the ground beneath it begins to move, settle, or weaken, the effects can be seen throughout the property—from cracked walls and uneven floors to sticking doors and sloping concrete slabs.", 'rectify-custom' ); ?></p>
                                <p><?php esc_html_e( 'At Rectify, we specialise in foundation repair for residential properties across Melbourne, Victoria, and South Australia. Our experienced ground engineering team identifies the underlying cause of foundation movement and delivers engineered solutions designed to restore stability while minimising disruption to your home.', 'rectify-custom' ); ?></p>
                                <p><?php esc_html_e( "Whether your property is experiencing early signs of settlement or more advanced structural movement, we're here to help protect your home with proven, long-term solutions.", 'rectify-custom' ); ?></p>
                            </div>
                            <figure class="rx-cracked-intro-media">
                                <img src="<?php echo esc_url( $foundation_images['intro'] ); ?>" alt="<?php esc_attr_e( 'Rectify technician and van assessing foundation movement beside a brick home', 'rectify-custom' ); ?>">
                            </figure>
                        </div>
                    </section>
                    <?php
            ...
            array(
                'key'    => 'residential-foundation-whatis',
                'render' => function () {
                    ?>
                    <section class="rx-cracked-whatis">
                        <div class="rx-wrap rx-cracked-whatis-grid">
                            <h2><?php esc_html_e( 'What Is Foundation Repair?', 'rectify-custom' ); ?></h2>
                            <div class="rx-cracked-whatis-copy">
                                <p><?php esc_html_e( 'Foundation repair is the process of stabilising and strengthening the ground and foundations that support your home. Rather than simply repairing visible cracks or cosmetic damage, effective foundation repair addresses the underlying cause of structural movement.', 'rectify-custom' ); ?></p>
                            </div>
                        </div>
                    </section>
                    <?php
            ...
            array(
                'key'    => 'residential-foundation-causes',
            ...
            array(
                'key'    => 'residential-foundation-matters',
                'render' => function () use ( $foundation_images ) {
                    ?>
                    <section class="rx-cracked-band rx-cracked-soft">
                        <div class="rx-wrap rx-cracked-matters-grid">
                            <figure class="rx-cracked-matters-media">
                                <img src="<?php echo esc_url( $foundation_images['why_matter'] ); ?>" alt="<?php esc_attr_e( 'Rectify technician carrying out a foundation assessment at night', 'rectify-custom' ); ?>">
                            </figure>
                            <div class="rx-cracked-matters-copy">
                                <h2><?php esc_html_e( 'Why Professional Assessment Is Important', 'rectify-custom' ); ?></h2>
                                <p><?php esc_html_e( 'At Rectify, we take an engineering-led approach to foundation repair. Our specialists carry out a comprehensive site assessment to identify the factors contributing to structural movement, including reactive soils, moisture fluctuations, erosion, inadequate ground compaction, voids beneath the foundation, or foundation settlement. Once the root cause has been identified, we develop a tailored remediation solution using proven techniques such as chemical underpinning, soil stabilisation, ground improvement, and foundation repair.', 'rectify-custom' ); ?></p>
                                <p><?php esc_html_e( 'Rather than simply repairing the visible damage, we address the source of the movement to restore structural stability and help protect your home against future foundation issues. Our long-term solutions have helped homeowners across Melbourne, Victoria and South Australia safeguard one of their most valuable assets.', 'rectify-custom' ); ?></p>
                            </div>
                        </div>
                    </section>
                    <?php
            ...
            array(
                'key'    => 'residential-foundation-advantage',
                'render' => function () use ( $foundation_images, $advantage_cards ) {
                    ?>
                    <section class="rx-cracked-advantage" style="<?php echo esc_attr( '--rx-cracked-contours:url(' . esc_url_raw( $foundation_images['contours'] ) . ');' ); ?>">
                        <div class="rx-wrap">
                        ...
                        <div class="rx-wrap">
                            ...
                            <div class="rx-cracked-compare">
                                <figure class="rx-cracked-compare-image">
                                    ...
                                    <img src="<?php echo esc_url( $foundation_images['before'] ); ?>" alt="<?php esc_attr_e( 'Before structural remediation', 'rectify-custom' ); ?>">
                                </figure>
                                ...
                                <figure class="rx-cracked-compare-image">
                                    ...
                                    <img src="<?php echo esc_url( $foundation_images['after'] ); ?>" alt="<?php esc_attr_e( 'After structural remediation', 'rectify-custom' ); ?>">
                                </figure>
                            </div>
                        </div>
                    </section>
            ...
            array(
                'key'    => 'residential-foundation-help',
                'render' => function () use ( $foundation_images ) {
                    ?>
                    <section class="rx-cracked-help" style="<?php echo esc_attr( '--rx-cracked-contours:url(' . esc_url_raw( $foundation_images['contours'] ) . ');' ); ?>">
                        <div class="rx-wrap">
                            ...
                            <div class="rx-cracked-help-grid">
                                <article class="rx-cracked-help-card">
                                    <span class="rx-cracked-help-icon" aria-hidden="true">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 72 72" fill="none">
                                            <g clip-path="url(#clip0_986_5061_fr)">
                                ...
                                <article class="rx-cracked-help-card">
                                    <span class="rx-cracked-help-icon" aria-hidden="true">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 72 72" fill="none">
                                            <g clip-path="url(#clip0_0_225_fr)">
