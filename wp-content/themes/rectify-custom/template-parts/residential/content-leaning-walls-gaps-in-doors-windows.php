<?php
/**
 * Leaning Walls & Gaps in Doors & Windows page content template.
 *
...
$wall_images = array(
    'hero'       => rx_asset_url( 'images/leaning-walls-gaps-in-doors-windows/intro-leaning-wall.png' ),
    'why_matter' => rx_asset_url( 'images/leaning-walls-gaps-in-doors-windows/matters-leaning-wall.jpg' ),
    'before'     => rx_asset_url( 'images/leaning-walls-gaps-in-doors-windows/before-img5135.jpg' ),
    'after'      => rx_asset_url( 'images/leaning-walls-gaps-in-doors-windows/after-img5114.jpg' ),
    'contours'   => rx_asset_url( 'images/home/Contour on Navy Blue.png' ),
);

$causes = array(
    array(
        'image' => 'images/leaning-walls-gaps-in-doors-windows/foundation-settlement.png',
        'title' => 'Foundation Settlement',
        'copy'  => array(
            'Foundation settlement occurs when the soil beneath a building compresses or loses its ability to support the structure evenly. As one section of the foundation settles more than another, the building can shift, causing walls to lean, crack, or move out of alignment.',
    ...
    array(
        'image' => 'images/leaning-walls-gaps-in-doors-windows/reactive-clay-soil.png',
        'title' => 'Reactive Clay Soils',
        'copy'  => array(
            'Reactive clay soils are common throughout many parts of Australia and naturally expand when they absorb moisture and shrink during dry conditions. These repeated cycles of expansion and contraction create movement beneath foundations.',
    ...
    array(
        'image' => 'images/leaning-walls-gaps-in-doors-windows/subsidence.png',
        'title' => 'Subsidence',
        'copy'  => array(
            'Subsidence is the downward movement of the ground beneath a building caused by weakening or loss of soil support. As the ground sinks, foundations may also move, allowing walls to lean or become misaligned.',
    ...
    array(
        'image' => 'images/leaning-walls-gaps-in-doors-windows/poor-soil-compaction.jpg',
        'title' => 'Poor Soil Compaction',
        'copy'  => array(
            'Buildings rely on properly compacted soil to provide long-term support. If fill material beneath the foundations was not adequately compacted during construction, it can continue to compress over time.',
    ...
    array(
        'image' => 'images/leaning-walls-gaps-in-doors-windows/erosion.png',
        'title' => 'Erosion',
        'copy'  => array(
            'Erosion gradually removes or weakens the soil supporting a building\'s foundations. Heavy rainfall, groundwater movement, poor surface drainage, or damaged stormwater systems can all contribute to the loss of supporting ground.',
    ...
    array(
        'image' => 'images/leaning-walls-gaps-in-doors-windows/drainage-issues.jpg',
        'title' => 'Drainage Issues',
        'copy'  => array(
            'Poor drainage around a property can have a significant impact on foundation performance. Water pooling near foundations or flowing beneath the building can alter soil moisture levels, weaken supporting ground, or contribute to erosion.',
                    ...
                    <section class="rx-cracked-band">
                        <div class="rx-wrap rx-cracked-intro-grid">
                            ...
                            <figure class="rx-cracked-intro-media">
                                <img src="<?php echo esc_url( $wall_images['hero'] ); ?>" alt="<?php esc_attr_e( 'Exterior corner of a house showing a leaning wall', 'rectify-custom' ); ?>">
                            </figure>
                        </div>
                    </section>
                    <?php
                    ...
                    <section class="rx-cracked-band rx-cracked-soft rx-cracked-band--flip">
                        <div class="rx-wrap rx-cracked-matters-grid">
                            <figure class="rx-cracked-matters-media">
                                <img src="<?php echo esc_url( $wall_images['why_matter'] ); ?>" alt="<?php esc_attr_e( 'Close up of a leaning brick wall', 'rectify-custom' ); ?>">
                            </figure>
